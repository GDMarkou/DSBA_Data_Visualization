...
def plot_seasonality_map(accidents_df):
    ...
    #fig.show()
    return fig
# Title : seasonality map of accidents in Paris according to the age
# Description : graph that plots for the whole year, month by month, for the selected age group, the density map
st.title("Seasonality map of accidents in Paris")
