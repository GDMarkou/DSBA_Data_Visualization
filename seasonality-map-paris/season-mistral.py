...
fig.frames = frames
# Create a list of dictionaries for the 'args' parameter
args_list = [{"frame": {"duration": 300, "redraw": True},
              "mode": "immediate",
              "transition": {"duration": 300, "easing": "cubic-in-out"},
              "slider": {"value": month, "suffix": " : " + calendar.month_name[month]}} for month in range(1, 13)]

# Create a list of steps using list comprehension
slider_steps = [dict(args=[arg], label=str(month)) for month, arg in enumerate(args_list, start=1)]
